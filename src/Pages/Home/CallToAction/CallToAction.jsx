    ...
    <div>
      <div className="px-3 md:lg:xl:px-40 bg-[url('https://www.toptal.com/designers/subtlepatterns/uploads/dot-grid.png')]   border-t border-b py-20 bg-opacity-10">
       ...
       <div className="grid grid-cols-1 md:lg:xl:grid-cols-3 group bg-white shadow-xl shadow-neutral-100 border ">
        ...
        <div className="w-full   bg-indigo-600 shadow-xl space-y-4 shadow-indigo-200 py-10 px-10 flex flex-col  md:flex-row justify-between items-center md:px-20">
          ...
          <button className="px-5 py-3  font-medium text-slate-700 shadow-xl rounded-lg hover:bg-white duration-150  bg-green-400">
            REGISTER NOW{" "}
          </button>
        </div>
       </Container>
